...
return new class extends Migration
{
    ...
    {
        // Upgrade system prompt jadi AI Sales Agent: tambah qualifying question,
        // objection handling, dan closing yang lebih natural — tanpa mengubah
        // aturan format WA/batas topik/anti-mengarang/whitelist URL yang sudah ada.
        $systemPrompt = <<<'PROMPT'
