...
return new class extends Migration
{
    ...
    {
        // Tambah larangan pakai tanda pisah panjang (—) berlebihan di FORMAT WA — model
        // sering kepakai gaya tulisan "—" ala esai/artikel yang terasa kaku buat chat WA,
        // ganti ke koma/titik/kalimat pendek biar lebih natural kayak orang chat beneran.
        $systemPrompt = <<<'PROMPT'
