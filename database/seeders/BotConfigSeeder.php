...
PROMPT;
        ...
        $configs = [
            ...
            ['key' => 'ai_rag_top_k',          'value' => '5',                                              'type' => 'number',   'label' => 'RAG Top-K',                        'description' => 'Jumlah maksimal potongan knowledge base yang disisipkan per pesan (0-15). Isi 0 untuk menonaktifkan RAG.', 'group' => 'ai'],
            ['key' => 'ai_rag_min_score',      'value' => '0.55',                                           'type' => 'number',   'label' => 'RAG Min Score',                    'description' => 'Ambang skor kemiripan (0.0-1.0) agar sebuah chunk dianggap relevan.', 'group' => 'ai'],
